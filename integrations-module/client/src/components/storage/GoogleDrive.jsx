...
import { FaFolder, FaFile, FaDownload, FaTrash, FaUpload, FaPlus, FaGoogle } from 'react-icons/fa';
...
const GoogleDrive = () => {
  ...
  const [files, setFiles] = useState([
    { 
      ...
      size: 1024 * 1024 * 2.3, 
      modifiedTime: '2023-07-15T09:30:00Z', 
    ...
    { 
      ...
      name: 'Lecture Notes', 
      size: null, 
      modifiedTime: '2023-07-10T14:20:00Z', 
    ...
    { 
      ...
      size: 1024 * 1024 * 5.7, 
      modifiedTime: '2023-07-05T11:15:00Z', 
    ...
    { 
      ...
      size: 1024 * 1024 * 3.2, 
      modifiedTime: '2023-06-28T08:45:00Z', 
    ...
    return (
      <Container>
        <ConnectSection>
          ...
          <ConnectTitle>Connect to Google Drive</ConnectTitle>
          <ConnectDescription>
            Connect to your Google Drive account to access and manage your files directly from this platform.
      ...
      <FilesTable>
        ...
        <TableBody>
          {filteredFiles.map(file => (
            <FileRow key={file.id}>
              <FileName isFolder={file.mimeType.includes('folder')}>
                {file.mimeType.includes('folder') ? <FaFolder /> : <FaFile />}
                <span>{file.name}</span>
              </FileName>
