...
import { FaFolder, FaFile, FaDownload, FaTrash, FaUpload, FaMicrosoft } from 'react-icons/fa';
...
const OneDrive = () => {
  ...
  const [files, setFiles] = useState([
    { 
      ...
      size: 1024 * 1024 * 1.3, 
      modifiedTime: '2023-07-05T09:30:00Z', 
    ...
    { 
      ...
      name: 'Documents', 
      size: null, 
      modifiedTime: '2023-06-20T14:20:00Z', 
      mimeType: 'folder' 
    },
    { 
      id: '3', 
      ...
      size: 1024 * 1024 * 2.5, 
      modifiedTime: '2023-07-01T11:15:00Z', 
  ...
  const handleDownload = (fileId) => {
    ...
    alert(`Downloading ${file.name} from OneDrive...`);
  };
    ...
    return (
      <Container>
        <ConnectSection>
          ...
          <ConnectTitle>Connect to OneDrive</ConnectTitle>
          <ConnectDescription>
            Connect to your Microsoft OneDrive account to access and manage your files directly from this platform.
            You'll be able to upload, download, and organize your files seamlessly.
          </ConnectDescription>
          <ConnectButton onClick={handleConnect}>
            <FaMicrosoft /> Connect OneDrive
          </ConnectButton>
        </ConnectSection>
      </Container>
    );
